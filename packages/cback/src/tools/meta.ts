...
export const createMetaNode: Tool = {
    definition: {
        name: "createMetaNode",
        description:
            "Create a new META concept (meta-node) under the project ROOT — **metamodel only**. " +
...
export const setMetaPointer: Tool = {
    definition: {
        name: "setMetaPointer",
        description:
            "Define or change a META-level pointer on an **existing** concept (use conceptPath from getMetaInfo)—do not create a new concept with createMetaNode when the user only wants new pointers. " +
