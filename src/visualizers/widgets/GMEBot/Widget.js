define(["jquery", "./commands"], function ($, Commands) {
    ...
    const GMEBOT_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linejoin="round" class="gme-bot-btn-icon">' +
        ...
        '</svg>';
    const GMEBOT_ICON_TITLE_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linejoin="round" class="gme-bot-title-icon">' +
    ...
    class Widget {
        constructor(containerEl, client) {
            this._client = client;
        ...
        _render() {
            ...
            this._input = $('<input type="text" class="form-control input-sm" placeholder="Type a message...">');
        ...
        _getContext() {
            ...
            if (!client)
                return undefined;
            const projectId = typeof client.getActiveProjectId === "function" ? client.getActiveProjectId() : undefined;
            const branchName = typeof client.getActiveBranchName === "function" ? client.getActiveBranchName() : undefined;
            const g = (typeof window !== "undefined" && window.WebGMEGlobal) || undefined;
        ...
        _executeCommands(commands) {
            const log = (sender, text) => this._appendMessage(sender, text);
